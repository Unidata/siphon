...
def test_wyoming():
    ...
    assert_almost_equal(df['theta'][5],302.6,2)
    assert_almost_equal(df['theta_e'][5],338.3,2)
    assert_almost_equal(df['theta_v'][5],304.8,2)
    ...
    assert(df.units['theta'] == 'kelvin')
    assert(df.units['theta_e'] == 'kelvin')
    assert(df.units['theta_v'] == 'kelvin')
...
def test_wyoming_no_station():
    ...
    assert_almost_equal(df['theta'][5],298.1,2)
    assert_almost_equal(df['theta_e'][5],329.2,2)
    assert_almost_equal(df['theta_v'][5],300.0,2)
...
def test_high_alt_wyoming():
    ...
    assert_almost_equal(df['theta'][2],288.0,2)
    assert_almost_equal(df['theta_e'][2],304.4,2)
    assert_almost_equal(df['theta_v'][2],289.0,2)
