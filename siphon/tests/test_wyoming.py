...
def test_wyoming():
    ...
    assert_almost_equal(df['relative_humidity'][5], 82, 1)
    assert_almost_equal(df['mixing_ratio'][5], 11.99, 2)
    ...
    assert_almost_equal(df['potential_temperature'][5],302.6,2)
    assert_almost_equal(df['equivalent_potential_temperature'][5],338.3,2)
    assert_almost_equal(df['virtual_potential_temperature'][5],304.8,2)

    assert(df.units['pressure'] == 'hPa')
    assert(df.units['height'] == 'meter')
    assert(df.units['temperature'] == 'degC')
    assert(df.units['dewpoint'] == 'degC')
    assert(df.units['relative_humidity'] is None)
    assert(df.units['mixing_ratio'] is None)
    ...
    assert(df.units['equivalent_potential_temperature'] == 'kelvin')
...
def test_wyoming_no_station():
    ...
    assert_almost_equal(df['relative_humidity'][5],89,1)
    assert_almost_equal(df['mixing_ratio'][5],10.61,2)
    ...
    assert_almost_equal(df['potential_temperature'][5],298.1,2)
    assert_almost_equal(df['equivalent_potential_temperature'][5],329.2,2)
    assert_almost_equal(df['virtual_potential_temperature'][5],300.0,2)
...
def test_high_alt_wyoming():
    ...
    assert_almost_equal(df['relative_humidity'][2],90,2)
    assert_almost_equal(df['mixing_ratio'][2],5.72,2)
    ...
    assert_almost_equal(df['potential_temperature'][2],288.0,2)
    assert_almost_equal(df['equivalent_potential_temperature'][2],304.4,2)
    assert_almost_equal(df['virtual_potential_temperature'][2],289.0,2)
