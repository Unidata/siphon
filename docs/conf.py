...
# Obtain current date for copyright range
...
copyright = (
    f'2008\u2013{cur_date:%Y}, Siphon Developers. '
    'Development is supported by NSF Unidata and the National Science Foundation'
)
...
latex_documents = [
  ('index', 'siphon.tex', 'Siphon Documentation',
   'Unidata', 'manual'),
]
