...
openssl aes-256-cbc -K $encrypted_6b6419a8fe94_key -iv $encrypted_6b6419a8fe94_iv -in ${TRAVIS_BUILD_DIR}/ci/deploy_key.enc -out ${TRAVIS_BUILD_DIR}/ci/deploy_key -d
